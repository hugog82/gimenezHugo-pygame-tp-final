...
class Enemy_2():
    def __init__(self,x,y,speed_walk) -> None:
        self.walk_left = Auxiliar.getSurfaceFromSpriteSheet (IMAGE_PATH+"enemy/deimaginator/npc_deimaginator__x1_walk_png_1354836023.png",3,6,flip=False, step=1)[:15]
        self.walk_right = Auxiliar.getSurfaceFromSpriteSheet (IMAGE_PATH+"enemy/deimaginator/npc_deimaginator__x1_walk_png_1354836023.png",3,6,flip=True, step=1)[:15]
...
class Enemy_4():
    def __init__(self,x,y,speed_walk) -> None:
        self.walk_right = Auxiliar.getSurfaceFromSpriteSheet (IMAGE_PATH+"enemy/jabba1/npc_jabba1__x1_idle_stand_part2_png_1354831135.png",9,9,flip=False, step=1)[:75]
        self.walk_left = Auxiliar.getSurfaceFromSpriteSheet (IMAGE_PATH+"enemy/jabba1/npc_jabba1__x1_idle_stand_part2_png_1354831135.png",9,9,flip=True, step=1)[:75]
        self.die_right = Auxiliar.getSurfaceFromSpriteSheet(IMAGE_PATH+"effects/explosions/explosion-4.png",12,1,flip=False, step=1)
        self.die_left = Auxiliar.getSurfaceFromSpriteSheet(IMAGE_PATH+"effects/explosions/explosion-4.png",12,1,flip=True, step=1)
        self.counter = 0
        self.frame = 0
...
class Enemy_5():
    def __init__(self,x,y,speed_walk) -> None:
        self.walk_right = Auxiliar.getSurfaceFromSpriteSheet (IMAGE_PATH+"enemy/rare_item_vendor/npc_rare_item_vendor__x1_walk_png_1354840072.png",4,4,flip=False, step=1)
        self.walk_left = Auxiliar.getSurfaceFromSpriteSheet (IMAGE_PATH+"enemy/rare_item_vendor/npc_rare_item_vendor__x1_walk_png_1354840072.png",4,4,flip=True, step=1)
        self.die_right = Auxiliar.getSurfaceFromSpriteSheet(IMAGE_PATH+"effects/explosions/explosion-4.png",12,1,flip=False, step=1)
        self.die_left = Auxiliar.getSurfaceFromSpriteSheet(IMAGE_PATH+"effects/explosions/explosion-4.png",12,1,flip=True, step=1)
        self.counter = 0
        self.frame = 0
...
class Enemy_7():
    def __init__(self,x,y,speed_walk) -> None:
        self.walk_right = Auxiliar.getSurfaceFromSpriteSheet (IMAGE_PATH+"enemy/pumpkin_lit_1/pumpkin_lit_1__x1_talk_png_1354836521.png",19,4,flip=False, step=1)[:74]
        self.walk_left = Auxiliar.getSurfaceFromSpriteSheet (IMAGE_PATH+"enemy/pumpkin_lit_1/pumpkin_lit_1__x1_talk_png_1354836521.png",19,4,flip=True, step=1)[:74]
        self.die_right = Auxiliar.getSurfaceFromSpriteSheet(IMAGE_PATH+"effects/explosions/explosion-4.png",12,1,flip=False, step=1)
        self.die_left = Auxiliar.getSurfaceFromSpriteSheet(IMAGE_PATH+"effects/explosions/explosion-4.png",12,1,flip=True, step=1)
        self.counter = 0
        self.frame = 0
